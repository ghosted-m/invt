...
function Body() {
  ...
  return (
    <div className='flex flex-col lg:flex-row w-full justify-between gap-8 md:px-16 p-4 mt-8'>
      <div style={{ boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)' }} className='md:py-16 py-4 flex flex-col items-center justify-center w-full lg:w-1/2'>
        <ConditionalRadio value={selectedForm} onChange={handleRadioChange} />
        {selectedForm === 'my_side' ? <MySide /> : <OtherSide />}
      </div>

      <div style={{ boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)' }} className='md:py-16 p-4 flex justify-center w-full lg:w-1/2'>
